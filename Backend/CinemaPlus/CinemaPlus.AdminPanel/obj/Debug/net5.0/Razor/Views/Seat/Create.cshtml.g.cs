#pragma checksum "C:\Users\UGHUR\Desktop\Finally-project\Backend\CinemaPlus\CinemaPlus.AdminPanel\Views\Seat\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "03381fd9e1a9fa779dc6e8bb1a5c61ea056da9f1"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"03381fd9e1a9fa779dc6e8bb1a5c61ea056da9f1", @"/Views/Seat/Create.cshtml")]
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "03381fd9e1a9fa779dc6e8bb1a5c61ea056da9f15933", async() => {
#nullable restore
...
#nullable disable
            ...
            DefineSection("Scripts", async() => {
                WriteLiteral("\r\n");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "03381fd9e1a9fa779dc6e8bb1a5c61ea056da9f110897", async() => {
                }
                );
...
<script>
    $(document).ready(function(){
        function setDataRow(selected, selectedColCount){
               ...
               $("".seats"").append(` <input class=""seat m-1 text-center"" value=""0"" type=""number"" data-row=${i} data-column=${j} data-seat-type=""0"" style=""border-radius:10px; border: 1px solid #4ee2a8; width:40px;"" min=""0""/>`);
               }
                $("".seats"").append(`</div>`);
               }
        }
         ...
         $(document).on(""click"", ""#create-hall-plan-btn"", function(){
            ...
            selectedSeats.toArray().map((item)=>{
             var seat = {
                 ...
                 column");
                WriteLiteral(@": $(item).attr(""data-column""),
